...
(function() {
  this.toggleModal = function(modalId) {
    var modal;
    modal = $("#" + modalId);
  ...
  $(document).on('turbolinks:load', function() {
    $("div.sprint-card--add").click(function(e) {
      e.preventDefault();
      return toggleModal("modal-sprint");
    });
    return $('.modal-background, .modal-close, .modal-card-head .delete, .modal-card-foot').click(function(e) {
      e.preventDefault();
      return toggleModal("modal-sprint");
    });
  });
